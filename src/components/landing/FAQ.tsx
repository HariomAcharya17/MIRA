...
const faqs = [
  { q: "Which AI models does Mira support?", a: "Mira routes through our personalized superfast AI inference. The catalog currently includes Llama 3.3, Llama 4 Scout, and specialized vision models. You can switch models mid-conversation." },
  ...
  { q: "Is there an API?", a: "An official Mira API is on the roadmap. Today, you can use our built-in high-performance inference for all your tasks directly within the workspace." },
